                                                  ...
                                                  const double &init_relative_time)
{
  ...
  while (t_param < Config_.FLAGS_trajectory_time_length)
  {
    ...
    // Set path_point for interpolation compatibility
    {
      PathPoint pp;
      pp.x = x; pp.y = y; pp.z = 0.0; pp.theta = theta;
      pp.kappa = kappa; pp.dkappa = 0.0; pp.s = s; pp.v = v; pp.a = a;
      trajectory_point.CopyFrom(pp);
      trajectory_point.set_path_point();
    }
